  ...
  return (
    <div ref={root} className="site-shell">
      ...
      <div ref={menu} className={`menu-overlay ${menuOpen ? "pointer-events-auto" : "pointer-events-none"}`}>
        ...
        <div className="menu-bottom menu-reveal"><div><RollLink label="Research" href="#process" /><RollLink label="Network" href="#service" /><RollLink label="Receipts" href="#projects" /></div><div><RollLink label="hello@capy.network" href="mailto:hello@capy.network" /><RollLink label="Closed-loop prototype" href="#about" /></div></div>
      </div>
